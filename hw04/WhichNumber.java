        ...
        switch(even){
            case 'Y'|'y':
                ...
                case 'N'|'n':
                    ...
                    char divbyfour=myScanner.next().charAt(0);
                    switch(divbyfour){
                        case 'Y'|'y':
                        System.out.print( "Is the number divided by four greater than 1?"); 
            ...
            System.out.print( "Is the number divisble by 3? ");
                char divbythree2=myScanner.next().charAt(0);
                switch(divbythree2){
                case 'Y'|'y':
                    System.out.print( "When Divided by 3 is the result great than 1? "); 
